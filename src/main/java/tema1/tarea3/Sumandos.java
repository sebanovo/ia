...
public class Sumandos {
     ...
     * 3. Encontrar todos los sumandos posibles iguales en una Lista.
     */
    private static boolean todosIguales(LinkedList<Integer> L) {
        int primero = L.get(0);
        for (int i = 0; i < L.size(); i++) {
            if (primero != L.get(i)) {
                return false;
    ...
    private static boolean todosPrimos(LinkedList<Integer> L) {
        for (int i = 0; i < L.size(); i++) {
            if (!esPrimo(L.get(i)))
                return false;
        }
     ...
     * 5. Encontrar todos los sumandos entre a y b inclusive en una Lista.
     */
    public static void sumandosEntreAB(LinkedList<Integer> L1, LinkedList<LinkedList<Integer>> L2, int n, int a,
            int b) {
        int sum = suma(L1);
        if (sum > n) {
            return;
    ...
    private static int multiplicacion(LinkedList<Integer> L) {
        int factores = 1;
        for (int i = 0; i < L.size(); i++) {
            factores *= L.get(i);
        }
     ...
     * 5. Encontrar todos los sumandos entre a y b inclusive en una Lista.
     */
    public static void factoresEntreAB(LinkedList<Integer> L1, LinkedList<LinkedList<Integer>> L2, int n, int a,
            int b) {
        int mul = multiplicacion(L1);
        if (mul > n) {
            return;
